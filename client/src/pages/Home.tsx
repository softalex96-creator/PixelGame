...
export default function Home() {
  ...
  return <div className="retro-home">
    <section className="retro-hero">
      ...
      <div className="cabinet-game-screen" aria-hidden="true">
        <span className="cabinet-game-glow" />
        <div className="pixel-alien-squad"><i className="pixel-alien alien-a" /><i className="pixel-alien alien-b" /><i className="pixel-alien alien-c" /><i className="pixel-alien alien-d" /><i className="pixel-alien alien-e" /></div>
        <span className="pixel-defender" /><span className="pixel-laser laser-one" /><span className="pixel-laser laser-two" /><span className="pixel-star star-one" /><span className="pixel-star star-two" />
      </div>
