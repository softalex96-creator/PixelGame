...
- [x] Assess a safe, supported workflow for keeping a user-managed local clone synchronized with GitHub
- [x] Inspect the requested ui-ux-pro-max-skill repository and its installation instructions before installation
- [x] Prepare a fresh local PixelGame clone/archive with a documented update command for the user's computer
